...
import de.muenchen.zms.ApiGatewayApplication;
...
import static de.muenchen.zms.TestConstants.SPRING_TEST_PROFILE;
...
class GlobalRequestParameterPollutionFilterTest {
    ...
    void parameterPollutionAttack() {
        ...
        webTestClient.get().uri("/api/zms-backend-service/testendpoint?parameter1=testdata_1&parameter2=testdata&parameter1=testdata_2").exchange()
                .expectStatus()
