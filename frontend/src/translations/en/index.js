export default {
  ...
  tooManyAppointmentsWithSameMailTitle: "Too many appointments with the same email address.",
tooManyAppointmentsWithSameMailText: "Please cancel any existing appointments if necessary to make a new reservation.",
  ...
  invalidTelephoneTitle: 'Invalid phone number',
  invalidTelephoneText: 'Please enter a valid phone number.',
