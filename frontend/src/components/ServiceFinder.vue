<template>
  <div>
    ...
    <v-container v-if="$store.state.data.service">
        ...
        <v-list-item :key="$store.state.data.service.id + ' ' + appointmentCountTriggered">
          <v-card-actions>
            <v-btn ref="buttonDown" class="appointment-count-button button-down"
              ...
              :aria-describedby="`appointment-count-name-` + $store.state.data.service.id" fab
            ...
            <v-list-item :key="subService.id + ' ' + appointmentCountTriggered">
              <v-card-actions>
                <v-btn ref="buttonDown" class="appointment-count-button button-down"
                  ...
                  :aria-describedby="`appointment-count-name-` + subService.id" fab
      ...
      <div>
        <v-btn class="button-next" elevation="2" depressed color="primary" @click="nextStep"
